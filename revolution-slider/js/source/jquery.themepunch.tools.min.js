...
if (window.tplogs==true)
	try {
		console.groupCollapsed("Momina GreenSocks Logs");
	} catch(e) { }
...
if (window.tplogs==true)
	try {
		console.info("Build GreenSock SandBox for Momina Plugins");
		console.info("GreenSock TweenLite Engine Initalised by Momina Plugin");
	} catch(e) {}
