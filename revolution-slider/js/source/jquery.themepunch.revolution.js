/**************************************************************************
 * jquery.Momina.revolution.js - jQuery Plugin for Revolution Slider
	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
			...
			return this.each(function() {	
				...
				options.jsFileLocation = options.jsFileLocation || getScriptLocation("Momina.revolution.min.js");						
...
jQuery.extend(true, _R, {
	...
	compare_version : function(extension) {
		...
		if (v.Core===undefined) {
			...
			v.Core.name = "jquery.Momina.revolution.min.js";
...
var getScriptLocation = function(a) {
	...
	var srcexp = new RegExp("Momina.revolution.min.js","gi"),
		ret = "";
	...
	ret = ret.replace('jquery.Momina.revolution.min.js', ''); 
	ret = ret.replace('jquery.Momina.revolution.js', ''); 	
	ret = ret.split("?")[0];		
	return ret;
}
